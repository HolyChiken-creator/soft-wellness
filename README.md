# Soft Wellness 1.3 — камера та спільна Telegram-сесія
...
Safari PWA і Telegram WebView мають окремі сховища браузера, тому прямий обмін `localStorage` неможливий. У версії 1.3 стан синхронізується через існуючий Cloudflare Durable Object:
